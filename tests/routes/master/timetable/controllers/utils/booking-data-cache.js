...
const [checkIsBookingDataCache, checkIsBookingDataCacheDeleted] = checkCache(getCache);

module.exports = { getBookingData, checkIsBookingDataCache, checkIsBookingDataCacheDeleted };
